...
class NSRU_shortcodes {
	...
	public function __construct() {
		...
		add_shortcode( 'nsru_get_square', array( $this, 'nsru_get_square_shortcode' ) );
		add_shortcode( 'nsru_get_scholarship', array( $this, 'nsru_get_scholarship_shortcode' ) );
	...
	/**
	 * Returns the Online Ticket surcharge.
	 *
	 * The Online Ticket surcharge will be based on the if the date is before or after the end of discounted tickets.
	 *
	 * @return string
	 */
	...
	/**
	 * Get the Square Buy Now Code.
	 *
	 * The Square service charge will be displayed below the Buy Now Button
	 *
	 * @return string
	 */
	public function nsru_get_square_shortcode() {

		return '<span class="square"></span>';

	} // nsru_get_square_shortcode

	/**
	 * Get the Square Scholarship Code.
	 *
	 * @return string
	 */
	public function nsru_get_scholarship_shortcode() {

		return '<span class="scholarship"></span>';

	} // nsru_get_scholarship_shortcode
