...
class NSRU_Speakers {
    ...
    public function create_cpt() {
        ...
        if (version_compare($wp_version, '5.0', '>=')) {
            $labels['item_published'] = __('Speaker published', 'nsru-options', 'nsru-options');
    ...
    public function custom_column($column, $post_id) {
        ...
        switch ($column) {
            case 'name': echo $meta[0]['name'];
                break;
            case 'city': echo $meta[0]['city'];
                break;
            case 'province': echo $meta[0]['province'];
                break;
            case 'org':
